Public Class DailySalesCls
    ...
    Property TotalNonTaxableSalesAmount As Double
    Property TotalSeniorAndPWDDiscount As Double
    Property TotalOtherDiscountAndFreeItems As Double
    Property TotalRefundAmount As Double
    Property TotalTaxVatAmount As Double
    ...
    Property TotalControlNumber As String
